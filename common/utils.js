...
utils.classes = ["car", "fish", "house", "tree", "bicycle", "guitar", "pencil", "clock", "cloud", "snake", "star", "t_shirt", "bucket", "flower", "calculator", "pizza"];
...
utils.styles = {
   ...
   cloud: { color: "gray", text: "☁️" },
   snake: { color: "green", text: "🐍" },
   star: { color: "yellow", text: "⭐️" },
   t_shirt: { color: "red", text: "👕" },
   bucket: { color: "cyan", text: "🥡" },
   flower: { color: "magenta", text: "🌸" },
   calculator: { color: "gray", text: "📅" },
   pizza: { color: "red", text: "🍕" },
};
